...
# ^   Matches the beginning  -- ^this is beging
# $   Matches the end
...
# without using \, the . means any character
# match = re.search(r'.', s)
# print("The dot search output is - ",match)
...
# start_pattern = r'^Today'
# end_pattern = r'match$'
# r - This is useful when we want to have a string that contains backslash and don't want it to be treated as an escape character
# sentence = "Today is Argentina vs Croatia match"
...
# # . – Dot,
# | – Or,
# ? – (0 or 1 character )Question Mark,
# * – (0 or more character)Star,
# + – (1 or more character)Plus,
# {m, n} – (m = min and n = max)Braces
# {2, 5} - min 2 chars or max 5 chars = ot, rtyer
# --------------------------------------------------------------
# # \d, - searched of number in a string - r"this is 2022 world cup"
pattern = r'\d+'
# \w+
# --------------------------------------------------------------
# # \d - 0123456789
...
# --------------------------------------------------------------
# string_number = r"This is increasing 12 sequence 1234 567, and this is mixed 1423 567"
# pattern1 = r'\d{3,4}'
# pattern2 = r'\d+'
...
# pattern1 = r"[a-zA-Z]+ \d+"
# pattern2 = r"(([a-zA-Z]+) (\d+))"  # for creating groups for the pattern found

# match = re.search(
#     pattern2, "India won first cricket world cup in June 1983, jan 2011")
